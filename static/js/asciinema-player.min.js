var AsciinemaPlayer = (function (A) {
  ...
  const E = 1,
    i = 2,
    e = { owned: null, cleanups: null, context: null, owner: null };
  var o = null;
  let t = null,
    V = null,
    s = null,
  ...
  function D(A, g) {
    ...
    return [
      F.bind(I),
      (A) => ("function" == typeof A && (A = A(I.value)), N(I, A)),
    ];
  }
  function w(A, g, I) {
    d(R(A, g, !1, E));
  ...
  function l(A) {
    !(function (A, g, I) {
      C = q;
      const B = R(A, g, !1, E);
      (B.user = !0), n ? n.push(B) : d(B);
    })(() => M(A));
  }
  function y(A) {
    return (
      null === o ||
        (null === o.cleanups ? (o.cleanups = [A]) : o.cleanups.push(A)),
      A
    );
  }
  function G() {
  ...
  function F() {
    ...
    if (this.sources && (this.state || A))
      if (this.state === E || A) d(this);
        ...
        const A = s;
        (s = null), f(() => Y(this), !1), (s = A);
      }
    if (V) {
      const A = this.observers ? this.observers.length : 0;
      V.sources
        ? (V.sources.push(this), V.sourceSlots.push(A))
        : ((V.sources = [this]), (V.sourceSlots = [A])),
        this.observers
            ...
            for (let g = 0; g < A.observers.length; g += 1) {
              ...
              B && t.disposed.has(I),
                ((B && !I.tState) || (!B && !I.state)) &&
                  (I.pure ? s.push(I) : n.push(I), I.observers && S(I)),
                B || (I.state = E);
            }
    ...
    (V = o = A),
      (function (A, g, I) {
        ...
        (!A.updatedAt || A.updatedAt <= I) &&
          (null != A.updatedAt && "observers" in A ? N(A, B) : (A.value = B),
          (A.updatedAt = I));
      })(A, A.value, B),
      (V = I),
      (o = g);
  }
  function R(A, g, I, B = E, Q) {
    const C = {
      fn: A,
      state: B,
      updatedAt: null,
    ...
    return (
      null === o || (o !== e && (o.owned ? o.owned.push(C) : (o.owned = [C]))),
      C
    );
  }
  function u(A) {
  ...
  function J(A) {
    for (let g = 0; g < A.length; g++) u(A[g]);
  }
  function q(A) {
    let I,
      B = 0;
    ...
    var Q;
    for (g.context && (g.context = Q), I = 0; I < B; I++) u(A[I]);
  }
  function Y(A, g) {
    const I = t;
    A.state = 0;
  ...
  function S(A) {
    ...
    for (let I = 0; I < A.observers.length; I += 1) {
      ...
      (B.state && !g) ||
        ((B.state = i), B.pure ? s.push(B) : n.push(B), B.observers && S(B));
    }
  }
  function U(A) {
    let g;
  ...
  function L(A) {
    if ("function" == typeof A && !A.length) return L(A());
    if (Array.isArray(A)) {
      const g = [];
              ...
              M(() => {
                ...
                if (0 === M)
                  0 !== i &&
                    ...
                    I.fallback &&
                      ((Q = [m]),
                      (C[0] = a((A) => ((E[0] = A), I.fallback()))),
                      (i = 1));
                else if (0 === i) {
                  for (C = new Array(M), t = 0; t < M; t++)
                    (Q[t] = V[t]), (C[t] = a(s));
                  i = M;
                } else {
                  for (
                  ...
                  for (
                    ...
                    (B[c] = C[w]), (n[c] = E[w]), e && (r[c] = e[w]);
                  for (A = new Map(), g = new Array(c + 1), t = c; t >= D; t--)
                    (h = V[t]),
                      (o = A.get(h)),
                      (g[t] = void 0 === o ? -1 : o),
                      A.set(h, t);
              ...
              M(() => {
                ...
                for (
                  ...
                  Q < C.length && C[Q] !== t[Q]
                    ? e[Q](() => t[Q])
                    : Q >= C.length && (E[Q] = a(V));
                for (; Q < C.length; Q++) i[Q]();
                return (
                  (o = e.length = i.length = t.length),
                  (C = t.slice(0)),
                  (E = E.slice(0, o))
                );
              })
  ...
  function W(A) {
    ...
    return c(
      () => {
        ...
        const i = E.children,
          e = "function" == typeof i && i.length > 0;
        return (g = I || e), e ? M(() => i(C)) : i;
      },
      void 0,
      void 0,
    );
  ...
  function X(A, g, I, B = {}) {
    ...
    return (
      a((B) => {
        (Q = B),
          g === document ? A() : BA(g, A(), g.firstChild ? null : void 0, I);
      }, B.owner),
      () => {
        Q(), (g.textContent = "");
      }
  ...
  function _(A, g = window.document) {
    const I = g[O] || (g[O] = new Set());
    for (let B = 0, Q = A.length; B < Q; B++) {
      const Q = A[B];
      I.has(Q) || (I.add(Q), g.addEventListener(Q, QA));
    }
  }
  function $(A, g) {
  ...
  function CA(A, I, B, Q, C) {
    ...
    const E = typeof I,
      i = void 0 !== Q;
    if (
      ((A = (i && B[0] && B[0].parentNode) || A),
      "string" === E || "number" === E)
    ) {
      if (g.context) return B;
      if (("number" === E && (I = I.toString()), i)) {
        let g = B[0];
      ...
      if (Array.isArray(I)) {
        const E = [],
          e = B && Array.isArray(B);
        if (EA(E, I, B, C)) return w(() => (B = CA(A, E, B, Q, !0))), () => B;
        if (g.context) {
              ...
              : (function (A, g, I) {
                  ...
                  for (; E < Q || i < C; )
                    if (g[E] !== I[i]) {
                      ...
                      if (Q === E) {
                        const g =
                          C < B ? (i ? I[i - 1].nextSibling : I[C - i]) : e;
                        for (; i < C; ) A.insertBefore(I[i++], g);
                      } else if (C === i)
                        for (; E < Q; )
                          (o && o.has(g[E])) || g[E].remove(), E++;
                      else if (g[E] === I[C - 1] && I[i] === g[Q - 1]) {
                        const B = g[--Q].nextSibling;
                        A.insertBefore(I[i++], g[E++].nextSibling),
                        ...
                        if (null != B)
                          if (i < B && B < C) {
                            ...
                            if (V > B - i) {
                              const Q = g[E];
                              for (; i < B; ) A.insertBefore(I[i++], Q);
                            } else A.replaceChild(I[i++], g[E++]);
                          } else E++;
                        else g[E++].remove();
                      }
                    } else E++, i++;
        ...
        if (g.context && I.parentNode) return (B = i ? [I] : I);
        if (Array.isArray(B)) {
          if (i) return (B = eA(A, B, Q, I));
          eA(A, B, null, I);
        } else
  ...
  function EA(A, g, I, B) {
    ...
    for (let C = 0, E = g.length; C < E; C++) {
      ...
      else if (Array.isArray(E)) Q = EA(A, E, i) || Q;
      else if ("function" == typeof E)
        if (B) {
          for (; "function" == typeof E; ) E = E();
          Q =
            EA(A, Array.isArray(E) ? E : [E], Array.isArray(i) ? i : [i]) || Q;
        } else A.push(E), (Q = !0);
      else {
        const g = String(E);
  ...
  let oA;
  const tA = new Array(128).fill(void 0);
  function VA(A) {
    return tA[A];
  }
  tA.push(void 0, null, !0, !1);
  let sA = tA.length;
  function nA(A) {
    const g = VA(A);
    return (
  ...
  "undefined" != typeof TextDecoder && rA.decode();
  let aA = null;
  function DA() {
    return (
      (null !== aA && 0 !== aA.byteLength) ||
        (aA = new Uint8Array(oA.memory.buffer)),
      aA
    );
  }
  function wA(A, g) {
    return (A >>>= 0), rA.decode(DA().subarray(A, A + g));
  }
  function cA(A) {
    sA === tA.length && tA.push(tA.length + 1);
    const g = sA;
    return (sA = tA[g]), (tA[g] = A), g;
  }
  function hA(A) {
    const g = typeof A;
  ...
  function GA(A, g, I) {
    ...
    if (E !== B) {
      ...
      const g = DA().subarray(Q + E, Q + B);
      (E += yA(A, g).written), (Q = I(Q, B, E, 1) >>> 0);
    }
    return (MA = E), Q;
  }
  let kA = null;
  function FA() {
    return (
      (null !== kA && 0 !== kA.byteLength) ||
        (kA = new Int32Array(oA.memory.buffer)),
      kA
    );
  }
  let NA = null;
  function dA(A, g) {
    return (
      ...
      ((null !== NA && 0 !== NA.byteLength) ||
        (NA = new Uint32Array(oA.memory.buffer)),
  ...
  const RA =
    "undefined" == typeof FinalizationRegistry
      ? { register: () => {}, unregister: () => {} }
      : new FinalizationRegistry((A) => oA.__wbg_vtwrapper_free(A >>> 0));
  class uA {
    static __wrap(A) {
      A >>>= 0;
      const g = Object.create(uA.prototype);
      return (g.__wbg_ptr = A), RA.register(g, g.__wbg_ptr, g), g;
    }
    __destroy_into_raw() {
    ...
    free() {
      ...
      oA.__wbg_vtwrapper_free(A);
    }
    feed(A) {
      const g = GA(A, oA.__wbindgen_malloc, oA.__wbindgen_realloc),
        I = MA;
      return nA(oA.vtwrapper_feed(this.__wbg_ptr, g, I));
    }
    inspect() {
      let A, g;
      try {
        const Q = oA.__wbindgen_add_to_stack_pointer(-16);
        oA.vtwrapper_inspect(Q, this.__wbg_ptr);
        var I = FA()[Q / 4 + 0],
          B = FA()[Q / 4 + 1];
        return (A = I), (g = B), wA(I, B);
      } finally {
        oA.__wbindgen_add_to_stack_pointer(16), oA.__wbindgen_free(A, g, 1);
      }
    }
    get_size() {
      try {
        const B = oA.__wbindgen_add_to_stack_pointer(-16);
        oA.vtwrapper_get_size(B, this.__wbg_ptr);
        var A = FA()[B / 4 + 0],
          g = FA()[B / 4 + 1],
          I = dA(A, g).slice();
        return oA.__wbindgen_free(A, 4 * g, 4), I;
      } finally {
        oA.__wbindgen_add_to_stack_pointer(16);
      }
    }
    get_line(A) {
      return nA(oA.vtwrapper_get_line(this.__wbg_ptr, A));
    }
    get_cursor() {
      return nA(oA.vtwrapper_get_cursor(this.__wbg_ptr));
    }
  }
  function fA() {
    const A = { wbg: {} };
    return (
      ...
      (A.wbg.__wbg_set_388c4c6422704173 = function (A, g, I) {
        return cA(VA(A).set(VA(g), VA(I)));
      }),
      (A.wbg.__wbindgen_debug_string = function (A, g) {
        const I = GA(hA(VA(g)), oA.__wbindgen_malloc, oA.__wbindgen_realloc),
          B = MA;
        (FA()[A / 4 + 1] = B), (FA()[A / 4 + 0] = I);
      }),
      (A.wbg.__wbindgen_throw = function (A, g) {
        throw new Error(wA(A, g));
      }),
      A
    );
  }
  ...
  var YA = Object.freeze({
    ...
    initSync: function (A) {
      ...
      return (
        ...
        JA(new WebAssembly.Instance(A, g), A)
      );
    },
  });
  const SA = [
  ...
  const pA = (function (A) {
    ...
    for (let I = 0, C = 0; I < B; I += 4, C += 3)
      (g =
        (UA(A.charCodeAt(I)) << 18) |
        (UA(A.charCodeAt(I + 1)) << 12) |
        (UA(A.charCodeAt(I + 2)) << 6) |
        UA(A.charCodeAt(I + 3))),
        (Q[C] = g >> 16),
        (Q[C + 1] = (g >> 8) & 255),
        (Q[C + 2] = 255 & g);
  ...
  class zA extends bA {
    async init() {
      try {
        return await this.core.initializeDriver(), this.core.setState("idle");
      } catch (A) {
  ...
  class vA extends bA {
    onEnter(A) {
      ...
      this.core.dispatchEvent("idle", { message: I }),
        "paused" === g && this.core.dispatchEvent("pause");
    }
    async play() {
      this.core.dispatchEvent("play"), await this.doPlay();
    }
    async doPlay() {
  ...
  class TA extends bA {
    onEnter(A) {
      let { message: g } = A;
      this.core.dispatchEvent("offline", { message: g });
    }
  }
  class WA extends bA {
    onEnter(A) {
      let { message: g } = A;
      this.core.dispatchEvent("ended", { message: g });
    }
    async play() {
      this.core.dispatchEvent("play"),
        (await this.driver.restart()) && this.core.setState("playing");
    }
    async togglePlay() {
      await this.play();
    }
    seek(A) {
      return !0 === this.driver.seek(A) && (this.core.setState("idle"), !0);
    }
  }
  class jA extends bA {
    onEnter() {
  ...
  class OA {
    ...
    async init() {
      ...
      if (
        ...
        let g = new HA();
        (this.driver.play = () => ((g = new mA(this.speed)), A())),
    ...
    setState(A) {
      ...
      if (((this.stateName = A), "playing" === A)) this.state = new xA(this);
      else if ("idle" === A) this.state = new vA(this);
      else if ("loading" === A) this.state = new ZA(this);
      else if ("ended" === A) this.state = new WA(this);
      else if ("offline" === A) this.state = new TA(this);
      else {
    ...
    resetVt(A, g) {
      ...
      (this.cols = A),
        ...
        this.dispatchEvent("reset", { cols: A, rows: g, theme: B });
    }
    initializeVt(A, g) {
    ...
    parsePoster(A) {
      return "string" != typeof A
        ...
        : "data:text/plain," == A.substring(0, 16)
          ...
          : "npt:" == A.substring(0, 4)
            ? { type: "npt", value: LA(A.substring(4)) }
            : {};
    }
    renderPoster(A) {
  ...
  const XA = Symbol("store-raw"),
    PA = Symbol("store-node"),
    _A = Symbol("store-name");
  function $A(A, g) {
    let B = A[I];
    if (
      !B &&
      (Object.defineProperty(A, I, { value: (B = new Proxy(A, Eg)) }),
      !Array.isArray(A))
    ) {
  ...
  function gg(A, g = new Set()) {
    let I, B, Q, C;
    if ((I = null != A && A[XA])) return I;
    if (!Ag(A) || g.has(A)) return A;
    if (Array.isArray(A)) {
      Object.isFrozen(A) ? (A = A.slice(0)) : g.add(A);
      for (let I = 0, C = A.length; I < C; I++)
        (Q = A[I]), (B = gg(Q, g)) !== Q && (A[I] = B);
    } else {
      Object.isFrozen(A) ? (A = Object.assign({}, A)) : g.add(A);
      const I = Object.keys(A),
        E = Object.getOwnPropertyDescriptors(A);
      for (let i = 0, e = I.length; i < e; i++)
        (C = I[i]),
          E[C].get || ((Q = A[C]), (B = gg(Q, g)) !== Q && (A[C] = B));
    }
    return A;
  }
  function Ig(A) {
    let g = A[PA];
    return g || Object.defineProperty(A, PA, { value: (g = {}) }), g;
  }
  function Bg(A, g, I) {
    return A[g] || (A[g] = Cg(I));
  }
  ...
  const Eg = {
    get(A, g, Q) {
      if (g === XA) return A;
      if (g === I) return Q;
      if (g === B) return Qg(A), Q;
      const C = Ig(A),
        E = C.hasOwnProperty(g);
      let i = E ? C[g]() : A[g];
      if (g === PA || "__proto__" === g) return i;
      if (!E) {
        const I = Object.getOwnPropertyDescriptor(A, g);
        !G() ||
          ("function" == typeof i && !A.hasOwnProperty(g)) ||
          (I && I.get) ||
          (i = Bg(C, g, i)());
      }
      return Ag(i) ? $A(i) : i;
  ...
  function og(A, g, I = []) {
    ...
    if (g.length > 1) {
      ...
      const C = typeof B,
        E = Array.isArray(A);
      if (Array.isArray(B)) {
        for (let Q = 0; Q < B.length; Q++) og(A, [B[Q]].concat(g), I);
        return;
      }
      if (E && "function" === C) {
        for (let Q = 0; Q < A.length; Q++)
          B(A[Q], Q) && og(A, [Q].concat(g), I);
        return;
      }
      if (E && "object" === C) {
        const { from: Q = 0, to: C = A.length - 1, by: E = 1 } = B;
        for (let B = Q; B <= C; B += E) og(A, [B].concat(g), I);
        return;
      }
      if (g.length > 1) return void og(A[B], g, [B].concat(I));
      (Q = A[B]), (I = [B].concat(I));
    }
    let C = g[0];
    ("function" == typeof C && ((C = C(Q, I)), C === Q)) ||
      (void 0 === B && null == C) ||
      ((C = gg(C)),
      void 0 === B || (Ag(Q) && Ag(C) && !Array.isArray(C))
        ? eg(Q, C)
        : ig(A, B, C));
  }
  function tg(...[A, g]) {
  ...
  const Vg = Symbol("store-root");
  function sg(A, g, I, B, Q) {
    const C = g[I];
    if (A === C) return;
    if (!Ag(A) || !Ag(C) || (Q && A[Q] !== C[Q])) {
      if (A !== C) {
        if (I === Vg) return A;
        ig(g, I, A);
      }
    ...
    if (Array.isArray(A)) {
      if (A.length && C.length && (!B || (Q && A[0] && null != A[0][Q]))) {
        let g, I, E, i, e, o, t, V;
        for (
          E = 0, i = Math.min(C.length, A.length);
          E < i &&
        ...
        const s = new Array(A.length),
          n = new Map();
        for (
          i = C.length - 1, e = A.length - 1;
          i >= E &&
          e >= E &&
          (C[i] === A[e] || (Q && C[E] && A[E] && C[i][Q] === A[e][Q]));
          i--, e--
        )
          s[e] = C[i];
        if (E > e || E > i) {
          for (I = E; I <= e; I++) ig(C, I, A[I]);
          for (; I < A.length; I++) ig(C, I, s[I]), sg(A[I], C, I, B, Q);
        ...
        for (g = E; g <= i; g++)
          (o = C[g]),
            ...
            void 0 !== I &&
              -1 !== I &&
              ((s[I] = C[g]), (I = t[I]), n.set(V, I));
        for (I = E; I < A.length; I++)
          I in s ? (ig(C, I, s[I]), sg(A[I], C, I, B, Q)) : ig(C, I, A[I]);
      } else for (let g = 0, I = A.length; g < I; g++) sg(A[g], C, g, B, Q);
      return void (C.length > A.length && ig(C, "length", A.length));
    }
    const E = Object.keys(A);
    for (let g = 0, I = E.length; g < I; g++) sg(A[E[g]], C, E[g], B, Q);
    const i = Object.keys(C);
    for (let g = 0, I = i.length; g < I; g++)
      void 0 === A[i[g]] && ig(C, i[g], void 0);
  }
  function ng(A, g = {}) {
    const { merge: I, key: B = "id" } = g,
      Q = gg(A);
    return (A) => {
      if (!Ag(A) || !Ag(Q)) return Q;
      const g = sg(Q, { [Vg]: A }, Vg, I, B);
      return void 0 === g ? A : g;
    };
  }
  const rg = P("<span></span>");
  var ag = (A) => {
    const g = c(() => {
        if (1 == A.text.length) {
      ...
      B = c(() =>
        (function (A, g, I, B) {
          const Q = A.get("fg"),
            C = A.get("bg");
          let E = { "--offset": g, width: I * B + 0.01 + "ch" };
          "string" == typeof Q && (E["--fg"] = Q);
          "string" == typeof C && (E["--bg"] = C);
          return E;
        })(A.pen, A.offset, I().length, A.charWidth),
      ),
      Q = c(() =>
        (function (A, g, I) {
          const B = Dg(A.get("fg"), A.get("bold"), "fg-"),
            Q = Dg(A.get("bg"), A.get("blink"), "bg-");
          let C = I ?? "";
        ...
        w(
          (g) => {
            const I = Q(),
              C = B();
            return (
              I !== g._v$ && $(A, (g._v$ = I)), (g._v$2 = gA(A, C, g._v$2)), g
            );
          },
  ...
  const wg = P('<span class="ap-line" role="paragraph"></span>');
  var cg = (A) =>
    (() => {
              ...
              K(
                ...
                (function (...A) {
                  ...
                  for (let B = 0; B < A.length; B++) {
                    const Q = A[B];
                    (g = g || (!!Q && I in Q)),
                      (A[B] = "function" == typeof Q ? ((g = !0), c(Q)) : Q);
                  }
                  if (g)
                    return new Proxy(
                      {
                        ...
                        has(g) {
                          for (let I = A.length - 1; I >= 0; I--)
                            if (g in v(A[I])) return !0;
                          return !1;
                        },
                        keys() {
                          const g = [];
                          for (let I = 0; I < A.length; I++)
                            g.push(...Object.keys(v(A[I])));
                          return [...new Set(g)];
                        },
                      },
                      z,
                  ...
                  for (let g = A.length - 1; g >= 0; g--)
                    if (A[g]) {
                      const I = Object.getOwnPropertyDescriptors(A[g]);
                      for (const g in I)
                        g in B ||
  ...
  var Mg = (A) => {
    ...
    return (() => {
      const g = hg.cloneNode(!0),
        C = A.ref;
      return (
        "function" == typeof C ? IA(C, g) : (A.ref = g),
        BA(
          g,
          K(x, {
            get each() {
  ...
  const lg = P(
    ...
    Gg = P('<span class="ap-playback-button" tabindex="0"></span>'),
    kg = P(
      '<span class="ap-progressbar"><span class="ap-bar"><span class="ap-gutter ap-gutter-empty"></span><span class="ap-gutter ap-gutter-full"></span></span></span>',
    ),
    Fg = P(
  ...
  var ug = (A) => {
    const g = (A) => (g) => {
      ...
      I = () =>
        "number" == typeof A.currentTime ? dg(A.currentTime) : "--:--",
      B = () =>
        "number" == typeof A.remainingTime ? "-" + dg(A.remainingTime) : I(),
      Q = c(() =>
    ...
    return (
      ...
      (() => {
        const C = Fg.cloneNode(!0),
          ...
          s = A.ref;
        return (
          "function" == typeof s ? IA(s, C) : (A.ref = C),
          BA(
            C,
            K(T, {
              get when() {
              ...
              get children() {
                const I = Gg.cloneNode(!0);
                return (
                  AA(I, "click", g(A.onPlayClick), !0),
                  BA(
                    I,
                    K(W, {
                      get children() {
            ...
            K(T, {
              ...
              get children() {
                ...
                return (
                  ...
                  w((g) =>
                    gA(C, { transform: `scaleX(${A.progress || 0}` }, g),
                  ),
                  I
                );
              },
  ...
  var Jg = (A) => fg.cloneNode(!0);
  const qg = P(
    '<div class="ap-overlay ap-overlay-loading"><span class="ap-loader"></span></div>',
  );
  var Yg = (A) => qg.cloneNode(!0);
  const Sg = P('<div class="ap-overlay ap-overlay-info"><span></span></div>');
  var Ug = (A) =>
    (() => {
      ...
      return (
        BA(I, () => A.message),
        w((g) => gA(I, { "font-family": A.fontFamily }, g)),
        g
      );
    })();
  const pg = P(
  ...
  var Hg = (A) =>
    (() => {
      ...
      return (
        ...
        w((I) => gA(g, { "font-family": A.fontFamily }, I)),
        g
      );
    })();
  _(["click"]);
  const Kg = P('<div class="ap-wrapper" tabindex="-1"><div></div></div>');
  var bg = (A) => {
    const g = A.logger,
      I = A.core,
      B = A.autoPlay,
    ...
    I.addEventListener("init", (A) => {
      ...
      h(() => {
        x({ cols: g, rows: I }), a(B), u(Q), G(E), Z(C);
      });
    }),
      ...
      I.addEventListener("terminalUpdate", () => {
        void 0 === Y && (Y = requestAnimationFrame(X));
      });
    const O = () => {
      (z = new ResizeObserver(
        (function (A, g) {
          ...
          C({ containerW: L.offsetWidth, containerH: L.offsetHeight }),
            L.dispatchEvent(new CustomEvent("resize", { detail: { el: m } }));
        }, 10),
      )),
        z.observe(L);
    };
    l(async () => {
      g.info("player mounted"),
        ...
        O();
      const { isPausable: A, isSeekable: E, poster: i } = await I.init();
      h(() => {
        C({
          isPausable: A,
          isSeekable: E,
          containerW: L.offsetWidth,
          containerH: L.offsetHeight,
        }),
          Z(i);
      }),
        B && I.play();
    ...
    const X = () => {
      ...
      QA = (A) => {
        if (!(A.altKey || A.metaKey || A.ctrlKey)) {
          if (" " == A.key) I.togglePlay();
            ...
            I.seek(100 * g + "%");
          } else if ("?" == A.key) N() ? d(!1) : (I.pause(), d(!0));
      ...
      VA = () => {
        clearInterval(p), C("blink", !0);
      },
      sA = (A) => {
        clearTimeout(S), A && (S = setTimeout(() => sA(!1), 2e3)), F(A);
      },
      nA = c(() => {
        const g = A.theme || "auto/asciinema";
        return "auto/" === g.slice(0, 5)
          ? { name: g.slice(5), colors: R() }
          : { name: g };
      }),
      rA = (() => {
        const g = Kg.cloneNode(!0),
          B = g.firstChild;
        "function" == typeof L ? IA(L, g) : (L = g),
          g.addEventListener("webkitfullscreenchange", _),
          g.addEventListener("fullscreenchange", _),
          (g.$$mousemove = CA),
          (g.$$keydown = QA);
        return (
          "function" == typeof m ? IA(m, B) : (m = B),
          (B.$$mousemove = () => sA(!0)),
          B.addEventListener("mouseleave", EA),
          BA(
            B,
            K(Mg, {
              get cols() {
            ...
            K(T, {
              ...
              get children() {
                return K(ug, {
                  ...
                  onFullscreenClick: AA,
                  onSeekClick: (A) => I.seek(A),
                  ref(A) {
                    "function" == typeof b ? b(A) : (b = A);
                  },
                });
              },
            }),
          ...
          w(
            (I) => {
              const Q = !!(!0 === A.controls || ("auto" === A.controls && k())),
                C = `ap-player asciinema-player-theme-${nA().name}`,
                E = (() => {
                  const g = {};
                  (!1 !== A.fit && "none" !== A.fit) ||
  ...
  class xg {
    ...
    transform(A) {
      return new xg(this.input, this.xfs.concat([A]));
    }
    multiplex(A, g) {
      return new xg(new Tg(this[Symbol.iterator](), A[Symbol.iterator](), g));
    }
    toArray() {
  ...
  async function Wg(A) {
    ...
    if (1 === g.version)
      return (function (A) {
        let g = 0;
        const I = new xg(A.stdout).map((A) => ((g += A[0]), [g, "o", A[1]]));
  ...
  function $g(A, g, I, B, Q, C) {
    if (0 === A)
      return (
        C.debug("using no buffer"),
        (function (A) {
          return {
            pushEvent(g) {
              if ("o" === g[1]) A(g[2]);
              else if ("r" === g[1]) {
                const [I, B] = g[2].split("x");
                A(`[8;${B};${I};t`);
              }
            },
            pushText(g) {
      ...
      );
    {
      ...
      return (
        "number" == typeof (A = A ?? {})
          ? (C.debug(`using fixed time buffer (${A} ms)`), (E = (g) => A))
          : "function" == typeof A
            ? (C.debug("using custom dynamic buffer"), (E = A({ logger: C })))
            : (C.debug("using adaptive buffer", A),
              (E = (function (A, g) {
                let { logger: I } = A,
                  {
                    minTime: B = 25,
                ...
                return (A) => {
                  if ((V.push(A), V.length < E)) return t;
                  V = V.slice(-E);
                  const g = V.reduce((A, g) => (g < A ? g : A));
                  const B = (function (A) {
                    return A.reduce((A, g) => (g > A ? g : A));
                  })(V);
                  (s = B * i + s * (1 - i)), (n = (B - g) * i + n * (1 - i));
                  const C = s + n;
                  if (
                    (A > t &&
                  ...
                  else if ((o > 1 && C < a(o - 2)) || (1 == o && C < a(o - 1)))
                    return (
                      null === r
                        ? (r = performance.now())
                        : performance.now() - r > e &&
  ...
  function II(A) {
    ...
    const g = (function (A) {
        const g = BI(A.subarray(0, 4)),
          I = BI(A.subarray(4, 8));
        return g + I / 1e6;
      })(A.subarray(0, 8)),
      I = BI(A.subarray(8, 12));
  ...
  const QI = new Map([
      [
        ...
        function (A, g) {
          let I,
            ...
            { feed: C, setState: E, now: i } = g,
            e = 0;
          return {
            async init() {
              const A = await Wg(await fetch(B)),
      ...
      [
        ...
        function (A, g, I) {
          ...
          return {
            init: () => {
              const A = [V].concat(n());
              return { cols: i, rows: e, duration: 1440, poster: A };
            },
            play: () => (E(V), r(), (s = setInterval(r, 1e3)), !0),
            stop: () => {
              clearInterval(s);
            },
            getCurrentTime: () => {
      ...
      [
        ...
        function (A, g) {
          let I,
            B,
            { url: Q, bufferTime: C, minFrameTime: E } = A,
            { feed: i, reset: e, setState: o, logger: t } = g;
          t = new vg(t, "eventsource: ");
          let V = new HA();
          function s(A) {
            void 0 !== B && B.stop(),
              (B = $g(C, i, (A) => V.setTime(A), A, E, t));
          }
          return {
            play: () => {
              (I = new EventSource(Q)),
                ...
                I.addEventListener("error", (A) => {
                  t.info("errored"), t.debug({ e: A }), o("loading");
                }),
                I.addEventListener("message", (A) => {
                  ...
                  if (Array.isArray(g)) B.pushEvent(g);
                    ...
                    "offline" === g.state &&
                      ...
                      o("offline", { message: "Stream offline" }),
                      (V = new HA()));
                }),
                I.addEventListener("done", () => {
                  t.info("closed"),
                    I.close(),
                    o("ended", { message: "Stream ended" });
                });
            },
            stop: () => {
        ...
        function (A, g, I) {
          ...
          function S(A) {
            ...
            if ("o" === I) s(B);
              ...
              return U(), (V = 1e3 * g), w("idle", { reason: "paused" }), !0;
            return !1;
          }
          function U() {
            return !o || (Y(), (V = a() - t), !0);
          ...
          function L(A) {
                ...
                : ">>" === A
                  ...
                  : "<<<" === A
                    ...
                    : ">>>" === A
                      ...
                      : "%" === A[A.length - 1] &&
                        (A =
                          (parseFloat(A.substring(0, A.length - 1)) / 100) * i);
            ...
            const B = Math.min(Math.max(A, 0), i);
            B < R && (s("c"), H(), (d = 0), (R = 0));
            let Q = C[d];
            for (; Q && Q[0] <= B; )
              "o" === Q[1] && S(Q), (R = Q[0]), (Q = C[++d]);
            return (V = 1e3 * B), (e = null), g && p(), !0;
          }
          function m(A) {
            if (0 == E.length) return;
            let g,
          ...
          return {
                ...
                s = (function (A, g, I) {
                  ...
                  void 0 === e &&
                    (e = (function (A) {
                      ...
                      const Q = new xg(g).map((A) => [A[0], "o", A[1]]),
                        C = new xg(I).map((A) => [A[0], "i", A[1]]),
                        E = new xg(B).map(Xg);
                  ...
                  const t = e[e.length - 1][0],
                    V = B - o.offset;
                  return { ...A, events: e, duration: t, effectiveStartAt: V };
                })(
                  await g(
                    await (function (A) {
                      let { url: g, data: I, fetchOpts: B = {} } = A;
                      if ("string" == typeof g) return f(g, B);
                      if (Array.isArray(g))
                        return Promise.all(g.map((A) => f(A, B)));
                      if (void 0 !== I)
                        return (
            ...
            play: function () {
              if (o) throw "already playing";
              if (void 0 === C[d]) throw "already ended";
              return null !== e && L(e), p(), !0;
            },
            pause: U,
            seek: L,
            step: function () {
            ...
            restart: function () {
              if (o) throw "still playing";
              if (void 0 !== C[d]) throw "not ended";
              return L(0), p(), !0;
            },
            stop: U,
            getCurrentTime: function () {
              return o ? (a() - t) / 1e3 : (V ?? 0) / 1e3;
            },
          };
        },
      ],
      [
        ...
        function (A, g) {
          let {
            ...
            { feed: E, reset: i, setState: e, logger: o } = g;
          o = new vg(o, "websocket: ");
          ...
          function c(A) {
            void 0 !== s && s.stop(),
              (s = $g(B, E, (A) => r.setTime(A), A, C, o));
          }
          function h(A) {
            if ("string" == typeof A.data)
              o.info("activating asciicast-compatible handler"),
                c(),
                (V.onmessage = M),
                M(A);
            else {
              ...
              if (65 == g[0] && 76 == g[1] && 105 == g[2] && 83 == g[3])
                1 == g[4]
                  ? (o.info("activating ALiS v1 handler"), (V.onmessage = y))
                  : (o.warn(`unsupported ALiS version (${g[4]})`), V.close());
              else {
                o.info("activating raw text handler"), c();
                const I = t.decode(g),
                  B =
                    (function (A) {
          ...
          function y(A) {
            ...
            let Q = 1;
            if (1 === B) {
              const A = I.getUint16(Q, !0);
              Q += 2;
              const B = I.getUint16(Q, !0);
              Q += 2;
              const C = I.getFloat32(Q, !0);
              Q += 4;
              const E = I.getUint8(Q);
              let i;
              (Q += 1),
                1 === E &&
                  ((i = (function (A) {
                    const g = G(A[0], A[1], A[2]),
                      I = G(A[3], A[4], A[5]),
                      B = [];
                    for (let g = 0; g < 16; g++)
                      B.push(G(A[3 * g + 6], A[3 * g + 7], A[3 * g + 8]));
                    return { foreground: g, background: I, palette: B };
                  })(new Uint8Array(g, Q, l))),
                  (Q += l));
              const e = I.getUint32(Q, !0);
              let o;
              (Q += 4),
                e > 0 && ((o = t.decode(new Uint8Array(g, Q, e))), (Q += e)),
                N(A, B, C, o, i);
            } else if (111 === B) {
              const A = I.getFloat32(1, !0),
                B = I.getUint32(5, !0),
                Q = t.decode(new Uint8Array(g, 9, B));
              s.pushEvent([A, "o", Q]);
            } else if (114 === B) {
              const A = I.getFloat32(1, !0),
                g = I.getUint16(5, !0),
                B = I.getUint16(7, !0);
              s.pushEvent([A, "r", `${g}x${B}`]);
            } else 4 === B ? d() : o.debug(`unknown frame type: ${B}`);
          }
          function G(A, g, I) {
            return `#${k(A)}${k(g)}${k(I)}`;
          }
          ...
          function F(A) {
            s.pushText(t.decode(A.data));
          }
          function N(A, g, I, B, Q) {
            o.debug(`stream reset (${A}x${g} @${I})`),
              e("playing"),
              c(I),
              i(A, g, B, Q),
              (r = new mA()),
              (w = !0),
              "number" == typeof I && r.setTime(I);
          }
          function d() {
            o.info("stream offline"),
              e(
                "offline",
                w ? { message: "Stream ended" } : { message: "Stream offline" },
              ),
              (r = new HA());
          }
          function R() {
            (V = new WebSocket(I)),
              ...
              (V.onclose = (A) => {
                if (D || 1e3 === A.code || 1005 === A.code)
                  o.info("closed"), e("ended", { message: "Stream ended" });
                else {
                  clearTimeout(n);
                  const A = Q(a++);
                  o.info(`unclean close, reconnecting in ${A}...`),
                    e("loading"),
                    setTimeout(R, A);
                }
              }),
          ...
          return {
            ...
            stop: () => {
              (D = !0), void 0 !== s && s.stop(), void 0 !== V && V.close();
            },
    ...
    CI = new Map([
      ...
      [
        ...
        async function (A, g) {
          ...
          const i = await A[1].arrayBuffer(),
            e = new Uint8Array(i),
            o = e.findIndex((A) => 10 == A) + 1,
            t = B.decode(e.subarray(0, o)).match(
              /COLUMNS="(\d+)" LINES="(\d+)"/,
            );
          null !== t && ((Q = parseInt(t[1], 10)), (C = parseInt(t[2], 10)));
          const V = { array: e, cursor: o };
          let s = V;
          if (void 0 !== A[2]) {
            const g = await A[2].arrayBuffer();
            s = { array: new Uint8Array(g), cursor: o };
          }
          const n = [];
          let r = 0;
          for (const A of E)
            if (((r += parseFloat(A[1])), "O" === A[0])) {
              const g = parseInt(A[2], 10),
                I = V.array.subarray(V.cursor, V.cursor + g),
                Q = B.decode(I);
              n.push([r, "o", Q]), (V.cursor += g);
            } else if ("I" === A[0]) {
              const g = parseInt(A[2], 10),
      ...
      [
        ...
        async function (A, g) {
          ...
          let t = 80,
            V = 24;
          null !== e && ((t = parseInt(e[2], 10)), (V = parseInt(e[1], 10)));
          let s = 0,
            n = II(C);
          for (; void 0 !== n; ) {
            const A = n.time - i,
              g = B.decode(n.data);
            o.push([A, "o", g]), (s += n.len), (n = II(C.subarray(s)));
          }
          return { cols: t, rows: V, events: o };
        },
      ],
    ]);
  return (
    (A.create = function (A, g) {
      ...
      const B = I.logger ?? new zg(),
        Q = new OA(
          (function (A) {
            ...
            if (
              ...
              if (!CI.has(A.parser)) throw `unknown parser: ${A.parser}`;
              A.parser = CI.get(A.parser);
            }
            if (QI.has(A.driver)) {
              const g = QI.get(A.driver);
              return (I, B) => g(A, I, B);
            }
        ...
        C = (function (A, g) {
          ...
          return E(), document.body.removeChild(Q), i;
      ...
      const e = X(() => ((i = K(bg, E)), i), g),
        o = {
          ...
          pause: () => Q.pause(),
          seek: (A) => Q.seek(A),
          addEventListener: (A, g) => Q.addEventListener(A, g.bind(o)),
        };
      return o;
    }),
    A
